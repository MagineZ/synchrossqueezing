addpath('C:\Users\NTU_Math\Downloads\Archive')
...
imageSQ(time, tfrsqtic*SamplingRate, abs(tfrsq), .995) ; colormap(1-gray) ; title('SST') ;

figure ;
imageSQ(time, tfrsqtic*SamplingRate, abs(ConceFT), .995) ; colormap(1-gray) ; title('ConceFT') ;
